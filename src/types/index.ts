...
export type AppView = 'landing' | 'login' | 'dashboard' | 'analysis' | 'quote' | 'projects' | 'quotes-list' | 'settings' | 'reports' | 'marketing' | 'analysis-hub' | 'hover-measure' | 'depth-measure' | 'accu-measure' | 'roof-wizard';
